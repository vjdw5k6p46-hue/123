...
This integration branch provides deterministic reference execution plus optional executable LLM-agent, archived/replay, hybrid, ablation, and external PhysiCell support.
...
Reviewer-facing safe demo bundle:
