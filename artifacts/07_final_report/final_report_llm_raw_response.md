...
Initial parameters were generated using an LLM agent, which synthesized literature evidence into structured hypotheses and proposed direct parameter choices. The parameters were validated and prepared for simulation.
...
IL-15 was the top cytokine arm in both pre-refine and post-refine low-antigen runs, demonstrating consistent performance in reducing tumor burden and enhancing CAR-T cell persistence.
