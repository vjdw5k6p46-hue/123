...
The output is an audit artifact. It does not overwrite deterministic outputs, does not include full-paper PDFs, does not fabricate citations, and does not fabricate PhysiCell or wet-lab results.
